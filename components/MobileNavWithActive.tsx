            ...
            return (
              <div key={link.title} className="px-12 py-4">
                ...
                >
                  {link.title}
                  {isActive && (
                    <span className="block h-0.5 bg-orange-500 dark:bg-orange-400 transform transition-all duration-300 mt-1 w-12" />
                  )}
                </Link>
              </div>
            )
...
export default MobileNavWithActive 